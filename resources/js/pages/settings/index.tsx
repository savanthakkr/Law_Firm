...
export default function Settings() {
  ...
  const { systemSettings = {}, cacheSize = '0.00', timezones = {}, dateFormats = {}, timeFormats = {}, paymentSettings = {}, webhooks = [], companySettings = [], auth = {} } = usePage().props as any;
  ...
  const sidebarNavItems = allSidebarNavItems.filter(item => {
    ...
    if (auth.user && auth.user.type === 'company') {
      ...
      return ['manage-email-settings', 'manage-brand-settings', 'manage-webhook-settings', 'settings'].includes(item.permission);
    }
    return false;
  });
