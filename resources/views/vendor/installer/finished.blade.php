...
@section('container')
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-6 mt-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white p-4 rounded border">
                <h4 class="font-medium text-gray-900 mb-2">Client User</h4>
                <div class="space-y-1 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600">Email:</span>
                        <code class="bg-gray-100 px-2 py-1 rounded text-xs">client2@company.com</code>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Password:</span>
                        <code class="bg-gray-100 px-2 py-1 rounded text-xs">password</code>
            ...
            <div class="bg-white p-4 rounded border">
                <h4 class="font-medium text-gray-900 mb-2">Team Member</h4>
                <div class="space-y-1 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600">Email:</span>
                        <code class="bg-gray-100 px-2 py-1 rounded text-xs">teammember2@company.com</code>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">Password:</span>
                        <code class="bg-gray-100 px-2 py-1 rounded text-xs">password</code>
