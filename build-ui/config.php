...
// Default should be the repository root. Since this file lives in public/build-ui,
// go two directories up by default.
define('PROJECT_ROOT', rtrim(getenv('PROJECT_ROOT') ?: dirname(__DIR__, 2), DIRECTORY_SEPARATOR));
